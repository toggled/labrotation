...
public class Iterative_trans_closure_random {
    ...
    static int max_dim; // highest dimension upto which Clique/Betti numbers would be computed.
    static void run_configs(){ 
        max_dim = 3;
        sampling_strategy = 0; 
        nodelimit = 100; // Number of nodes randomly sampled
    ...
    public static void main(String[] args) {
        ...
        for(int i =0;i<seedar.length;i++){
            ...
            // Construct Clique complex and compute barcodes.
             ...
             barcomp.runpersistence_algo(max_dim);
        }
